...
const initialRows = [
  createData(1, 'Tarefa Teste', 'Descrição da Tarefa 1', '2024-08-10', '2024-10-14', 'Concluída', 'Recurso 1'),
  ...
  createData(7, 'Tarefa Aleatoria', 'Esta é uma tarefa aleatória', '2024-08-09', '2022-01-08', 'Em Andamento', 'Recurso 4'),
  createData(8, 'Tarefa random', 'Já esta é random :)', '2022-02-14', '2022-04-20', 'Concluída', 'Recurso 2'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          title="Tarefas"
          subheader="Administração de Tarefas"
        /> 
        <CardContent>
